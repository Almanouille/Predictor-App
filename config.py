...
SELECTED_FEATURE_NAMES = ['team_a_goal_difference', 'team_a_goal_difference_avg', 'team_a_league_position', 'team_a_overall_points_per_game', 'team_a_points', 'team_b_goal_difference', 'team_b_goal_difference_avg', 'team_b_goals_against_avg', 'team_b_league_position', 'team_b_points']