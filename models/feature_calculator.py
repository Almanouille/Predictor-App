...
class FeatureCalculator:
    ...
    def compute_training_features(self, fixtures_df: pd.DataFrame, league_id: int, season: int) -> Tuple[pd.DataFrame, np.ndarray]:
        """
        ...
        :return: Tuple of (features_df with feature names as columns, target_vector).
        """
        features_list = []
        targets_list = []
        ...
        for idx, match in completed_matches.iterrows():
            try:
                ...
                if match_features_dict is not None:
                    ...
                    targets_list.append(target_map[match['match_result']])
